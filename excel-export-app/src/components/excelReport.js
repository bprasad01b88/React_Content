...
import CustomContextMenu from "./CustomContextMenu/CustomMenuContext";
  ...
  const [yPos, setYPos] = useState(0);
    ...
    return (
      ...
      />
        ...
        <MenuItem onClick={exportToExcel} style={{backgroud : "#000", color : "#fff"}}>Export to Excel</MenuItem>
      </ContextMenu> */}
        </Container>
    )
}
